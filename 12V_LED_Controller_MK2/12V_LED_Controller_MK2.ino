...
//PINs D1, D2, D3
#define PIN_LED_STRIP_1_RED D1
#define PIN_LED_STRIP_1_GREEN D2
#define PIN_LED_STRIP_1_BLUE D3

//PINs D5, D6, D7
#define PIN_LED_STRIP_2_RED D5
#define PIN_LED_STRIP_2_GREEN D6
#define PIN_LED_STRIP_2_BLUE D7
...
//# Global #//
uint8_t mqtt_Global_Fadespeed   = 0;
...
//------------------------------------------- Information -----------------------------------------//
//*************************************************************************************************//
uint8_t Network_NewData                     = 0;

uint16_t Information_MainState               = 0;
uint16_t Information_LightState              = 0;

uint8_t Information_mqtt_Global_Fadespeed   = 0;
